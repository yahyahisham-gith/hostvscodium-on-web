...
const encString = (buf, off, size, str) => str === undefined ? false : ((buf.write(str + NULLS, off, size, 'utf8'),
    str.length !== Buffer.byteLength(str) || str.length > size));//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/cfbea10c5ffb233ea9177d34726e6056e89913dc/node_modules/tar/dist/esm/header.js.map