    ...
    dispatch(opts, handler) {
        ...
        const wrappedHandler = Object.assign(Object.assign({}, handler), { 
            ...
            onHeaders(statusCode, rawHeaders, resume, statusText) {
                ...
                return (_b = (_a = handler.onHeaders) === null || _a === void 0 ? void 0 : _a.call(handler, statusCode, rawHeaders, resume, statusText)) !== null && _b !== void 0 ? _b : true;
            },
            onError(err) {
                var _a;
                ...
                return (_a = handler.onError) === null || _a === void 0 ? void 0 : _a.call(handler, err);
            },
 ...
 */
exports.testCertificates = [];//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/cfbea10c5ffb233ea9177d34726e6056e89913dc/node_modules/@vscode/proxy-agent/out/index.js.map