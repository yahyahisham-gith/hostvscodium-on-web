...
- Add: Example settings for vs code ([example/.vscode](https://github.com/Phu1237/vscode-vs-browser/blob/HEAD/example/.vscode))
- Add: Develop documentation ([DEVELOP.md](https://github.com/Phu1237/vscode-vs-browser/blob/HEAD/DEVELOP.md))
- Add: Changelog documentation ([CHANGELOG.md](https://github.com/Phu1237/vscode-vs-browser/blob/HEAD/CHANGELOG.md))
